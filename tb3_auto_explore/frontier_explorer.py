...
class FrontierExplorer(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter(
            "blacklist_clear_radius", 2.0
        )  # m, 블랙리스트 반경(월드)
        self.declare_parameter("retry_distance", 0.25)  # m, 프런티어에서 뒤로 당길 거리
        self.declare_parameter(
    ...
    def push_nav2_params(self) -> None:
        ...
        self._call_set_params(
            "/controller_server",
            {
                ...
                "FollowPath.forward_point_distance": 0.45,
                "FollowPath.prune_distance": 0.5,
                "FollowPath.max_vel_x": 0.3,
                "FollowPath.min_vel_x": 0.0001,
                "FollowPath.acc_lim_x": 3.0,
