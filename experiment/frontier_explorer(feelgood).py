...
class FrontierExplorer(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("goal_timeout_sec", 15.0)           # s, goal 도달 타임아웃
        self.declare_parameter("blacklist_clear_radius", 10)      # m, 블랙리스트 반경(월드)
        self.declare_parameter("retry_distance", 3)              # m, 프런티어에서 뒤로 당길 거리
